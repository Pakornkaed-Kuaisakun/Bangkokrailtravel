$(function () {
    var origin, destination, map, panel;
    ...
    var waypoints = [
        { location: { lat: 13.7466667, lng: 100.5305556 }, stopover: true },
        // { location: 'Terminal 21, Bangkok, Thailand', stopover: true }
    ];

    function displayRoute(travel_mode, origin, destination, directionsService, directionsDisplay, waypoints) {
        directionsService.route({
            origin: origin,
            destination: destination,
            travelMode: travel_mode,
            waypoints: [{ location: '451 Rama I Rd, Khwaeng Pathum Wan, Pathum Wan, Krung Thep Maha Nakhon 10330, Thailand', stopover: true }],
            avoidTolls: true
